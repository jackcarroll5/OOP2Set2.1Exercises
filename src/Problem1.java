...
public class Problem1 {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null,account.toString() ,"Message",
        ...
        BankAccount acc2 = new BankAccount(3245,300.00);
           ...
           JOptionPane.showMessageDialog(null,account2.toString(),"Message",
                   JOptionPane.INFORMATION_MESSAGE);
        ...
        JOptionPane.showMessageDialog(null,account3,"Message",
                JOptionPane.INFORMATION_MESSAGE);

         acc3.withdraw();
        JOptionPane.showMessageDialog(null,"\nAccount 3 after withdrawal is: \n" + acc3.toString(),"Message",
                JOptionPane.INFORMATION_MESSAGE);
